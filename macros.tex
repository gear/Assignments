...
\item[Titech student:] #1
\end{description}}
\newcommand{\smast}[1]{\begin{description}
\item[SMA students:] #1
\end{description}}

\newcommand{\profs}{Professors: Tsuyoshi Murata}
\newcommand{\subj}{ART.T458}
...
{\textit{Research Report: Fall 2016}\hfill\name\newline
...
{\textit{Research Report}\hfill#2\newline
Tokyo Institute of Technology \hfill Murata Lab\newline
