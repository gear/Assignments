...
\end{coqdoccode}
= \coqexternalref{Some}{http://coq.inria.fr/distrib/8.4pl5/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{Some}} (14 :: \coqexternalref{nil}{http://coq.inria.fr/distrib/8.4pl5/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{nil}}) : \coqexternalref{option}{http://coq.inria.fr/distrib/8.4pl5/stdlib/Coq.Init.Datatypes}{\coqdocinductive{option}} \coqdocdefinition{stack} 

 \vspace{1em}  \noindent  The theorem for this extended machine's correctness is proven in a similar way to \textbf{Q3.1}. I will prove an auxilary lemma \coqref{fmcs a2 ans3.ext compile correct'}{\coqdoclemma{ext\_compile\_correct'}}, and use it to prove the \coqref{fmcs a2 ans3.ext compile correct}{\coqdoclemma{ext\_compile\_correct}} theorem. 
