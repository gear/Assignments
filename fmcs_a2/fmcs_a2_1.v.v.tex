...
(** %\paragraph{Q3.1.}% We will do monkey stuff here! *)
...
(** * Question 1: Modified compiler and proof. *)
...
(** Given this modified instrDenote' function, try to modifiy the implementation of the compiler so that it suit the new definition and prove its correctness. *)
