...
My summarize has similar structure to Goto's paper: \textbf{Section 2} introduces all notations used in the paper. \textbf{Section 3} summarizes the layered approach for matrix multiplication. \textbf{Section 4} presents details inner-kernel implementation. The practical algorithm for popular cases is mentioned in \textbf{Section 5}. Finally, \textbf{Section 6} and \textbf{7} provides details for implementation on different architectures and experiment result.
